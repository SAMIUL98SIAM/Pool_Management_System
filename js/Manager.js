...
function validate(){
    ...
    if(get("fname").value == ""){
        get("fname").focus();
        get("err_fname").innerHTML="First Required";
        get("err_fname").style.color="red";
        hasError=true;
    }
    if(get("lname").value == ""){
        get("lname").focus();
        get("err_lname").innerHTML="Last Required";
    ...
    if(get("role").selected == false && get("role1").selected == false && get("role2").selected == false && get("role3").selected == false){
    ...
    if(get("about").value == ""){
        get("about").focus();
        get("err_about").innerHTML="Info Required";
