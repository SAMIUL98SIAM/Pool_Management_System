...
function checkUsername(control)
    {
        ...
        xhttp.onreadystatechange=function(){
            if(this.readyState == 4 && this.status == 200){
                ...
                if(rsp == "false"){
                    document.getElementById("err_username").innerHTML = "Not Valid Username";
        ...
        xhttp.open("GET","checkusernameForCustomer.php?username="+username,true);
        xhttp.send();
    }
    ...
    function checkUemail(control)
    {
        ...
        xhttp.open("GET","checkmailForCustomer.php?email="+email,true);
        xhttp.send();
    }
